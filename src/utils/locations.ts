...
export const PLACE_LOCATIONS = {
  'Bangkok': { lat: 13.6900, lng: 100.7501, emoji: '🇹🇭', color: '#DC2626' }, // red
  ...
  'Nusa Lembongan': { lat: -8.6854, lng: 115.4503, emoji: '⛰️', color: '#1D4ED8' }, // dark blue
  'Kuta': { lat: -8.7184, lng: 115.1681, emoji: '🏄', color: '#D946EF' }, // fuchsia
  'Komodo': { lat: -8.4867, lng: 119.8889, emoji: '🐉', color: '#14B8A6' }, // teal
